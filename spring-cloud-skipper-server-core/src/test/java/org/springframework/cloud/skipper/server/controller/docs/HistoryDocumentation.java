		...
		this.mockMvc.perform(
				...
				.andDo(this.documentationHandler.document(
						responseFields(
								...
								fieldWithPath("_embedded.releases[].packageMetadataId").description("The package metadata id"),
								fieldWithPath("_embedded.releases[].repositoryId").description("The repository id the package came from"),
